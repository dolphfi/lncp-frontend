    ...
    <Routes>
      ...
      >
        ...
        <Route
          path="/students"
          element={
            <RoleRoute requiredFeature="students">
              <StudentsManagement />
            </RoleRoute>
          }
        />
        <Route
          path="/courses"
          element={
            <RoleRoute requiredFeature="courses">
              <CoursesManagement />
            </RoleRoute>
          }
        />
        ...
        />
        <Route
          path="/schedules/my-schedule"
          element={
            <RoleRoute requiredFeature="academic">
              <MySchedule />
            </RoleRoute>
          }
        />
        ...
        <Route
          path="/employee"
          element={
            <RoleRoute requiredFeature="employees">
              <EmployeesManagement />
            </RoleRoute>
          }
        />
        ...
        <Route
          path="/admin_panel"
          element={
            <RoleRoute requiredFeature="admin">
              <AdminPanel />
            </RoleRoute>
          }
        />
        ...
        />
        <Route
          path="/re_registration"
          element={
            <RoleRoute requiredFeature="admin">
              <Re_registrationManagement />
            </RoleRoute>
          }
        />
        <Route
        ...
        <Route
          path="/payments"
          element={
            <RoleRoute requiredFeature="payments">
              <PaymentsManagement />
            </RoleRoute>
          }
        />
      ...
      <Route path="/academic" element={<DashboardLayout />}>
        ...
        <Route path="notes">
          <Route
            index
            element={
              <RoleRoute requiredFeature="notes">
                <NotesListWrapper />
              </RoleRoute>
            }
          />
